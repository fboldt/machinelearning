function elm = classifier_mlelm(FactorOfHiddenNeurons, ActivationFunction, Elm_Type)
%
% elm = classifier_mlelm(FactorOfHiddenNeurons, ActivationFunction, Elm_Type)
%
% %Example:
% dataset = load('datasets/iris.m');
% classifier = classifier_mlelm(); classifier.autotunning=true
...
%
elm.classifiername='MLELM - Multi Layer Extreme Learning Machine';
elm.train=@elmtrain;
