function experiment_cwru_filter(dummy_dataset_name, cla, fsm, numberofclassifiers, seed, autotunning)
%
% experiment_cwru_filter(dummy_dataset_name, cla, fsm, numberofclassifiers, seed, autotunning)
%
if exist('cla')==1
