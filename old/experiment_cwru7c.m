function experiment_cwru7c(dummy_dataset_name, cla, fsm, numberofclassifiers, seed, autotunning)
%
% experiment_cwru7c(dummy_dataset_name, cla, fsm, numberofclassifiers, seed, autotunning)
%
if exist('cla')==1
...
if exist('fsm')==1 && strcmp(fsm,'none')~=1
  ...
  fsmethod= eval(['feature_selection_',fsm]); 
  end
...
[results totaltime confusion trtime tetime numfeats]=run_experiment(classifier)
...
function [results totaltime confusion trtime tetime numfeats] = run_experiment(classifier)
nfolds=4; 
starttime=cputime;
