function experiment_clonalge(dataset_name, cla, fsm, numberofclassifiers, seed, autotunning)
%
% experiment_clonalge(dataset_name, cla, fsm, numberofclassifiers, seed, autotunning)
%
...
classifier = classifier_clonalge(fscriterion, classifier, numberofclassifiers);
if exist('seed')~=1
  seed=0; %randi(1000)
end
