function elm = classifier_elm(FactorOfHiddenNeurons, ActivationFunction, Elm_Type)
%
% elm = classifier_elm(FactorOfHiddenNeurons, ActivationFunction, Elm_Type)
%
% %Example:
% dataset = load('datasets/iris.m');
% classifier = classifier_elm(); classifier.autotunning=true
...
%
elm.classifiername='ELM - Extreme Learning Machine';
elm.train=@elmtrain;
elm.predict=@elmpredict;
elm.constructor=@classifier_elm;
if exist('Elm_Type')==1
...
elm_model.constructor=@classifier_elm;
end
