function experiment_cwru(dsopt, cla, fsm, numberofclassifiers, seed, autotunning)
%
% experiment_cwru(dsopt, cla, fsm, numberofclassifiers, seed, autotunning)
%
if exist('dsopt')~=1
  dsopt='cwru7c';
end
...
nfolds=4; 
starttime=cputime;
if strcmp(dsopt,'datasets/cwru19c')
