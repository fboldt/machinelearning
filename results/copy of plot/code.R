...
t5 <- c(as.matrix(read.table("plot//bcsalefda.m-experiment_round-none-01random_forest-atfalse.txt.csv", sep=";", quote="\"")[,-11]))

auxmethods = c("KNN","KNN+","KNN+R","KNN+HRG","RF+")
...
m3 <- read.csv("plot//bcsalefda.m-experiment_round-none-01random_forest-atfalse.txt.confusion.csv")
m4 <- read.csv("plot//bcsalefda.m-experiment_round-ranking-01knn-atfalse.txt.confusion.csv")
m5 <- read.csv("plot//bcsale.m-experiment_round-none-01knn-atfalse.txt.confusion.csv")
