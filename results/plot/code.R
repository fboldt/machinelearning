...
t3 <- c(as.matrix(read.table("plot//bcsalefda.m-experiment_fsround-ranking-01knn-atfalse.txt.csv", sep=";", quote="\"")[,-11]))
t4 <- c(as.matrix(read.table("plot//bcsalefda.m-experiment_iround-ranking-01knn-atfalse.txt.csv", sep=";", quote="\"")[,-11]))
t5 <- c(as.matrix(read.table("plot//bcsalefda.m-experiment_iround-cascade_rankingf18w-01knn-atfalse.txt.csv", sep=";", quote="\"")[,-11]))

auxmethods = c("KNN","KNN+","KNN+R","KNN+ER","KNN+ECR")
...
m1 <- read.csv("plot//bcsale.m-experiment_round-none-01knn-atfalse.txt.confusion.csv")
m2 <- read.csv("plot//bcsalefda.m-experiment_round-none-01knn-atfalse.txt.confusion.csv")
m3 <- read.csv("plot//bcsalefda.m-experiment_fsround-ranking-01knn-atfalse.txt.confusion.csv")
m4 <- read.csv("plot//bcsalefda.m-experiment_iround-ranking-01knn-atfalse.txt.confusion.csv")
m5 <- read.csv("plot//bcsalefda.m-experiment_iround-cascade_rankingf18w-01knn-atfalse.txt.confusion.csv")
