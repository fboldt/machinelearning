t1 <- c(as.matrix(read.table("isie2017-review//bcsale.m-experiment_round-none-01knn-atfalse.txt.csv", sep=";", quote="\"")[,-11]))
t2 <- c(as.matrix(read.table("isie2017-review//bcsalefda.m-experiment_round-none-01knn-atfalse.txt.csv", sep=";", quote="\"")[,-11]))
t3 <- c(as.matrix(read.table("isie2017-review//bcsalefda.m-experiment_fsround-ranking-01knn-atfalse.txt.csv", sep=";", quote="\"")[,-11]))
t4 <- c(as.matrix(read.table("isie2017-review//bcsalefda.m-experiment_round-ranking-01knn-atfalse.txt.csv", sep=";", quote="\"")[,-11]))

auxmethods = c("KNN","KNN+","KNN+FS","KNN+EFS")

pdf("isie2017-review//boxplot.pdf")
...
pdf("isie2017-review//lines1.pdf")
...
pdf("isie2017-review//lines2.pdf")
...
MN = M[,c(1,2,3,4)]
pdf("isie2017-review//matrix.pdf")
par(xaxt="n",yaxt="n")  
pairs(M, lower.panel= panel.smooth, upper.panel=panel.plot,font.labels = 1,cex.labels = 1.2)

################# Confusion matrix analisys 
pdf("isie2017-review//confusion.pdf")
m1 <- read.csv("isie2017-review//bcsale.m-experiment_round-none-01knn-atfalse.txt.confusion.csv")
m2 <- read.csv("isie2017-review//bcsalefda.m-experiment_round-none-01knn-atfalse.txt.confusion.csv")
m3 <- read.csv("isie2017-review//bcsalefda.m-experiment_fsround-ranking-01knn-atfalse.txt.confusion.csv")
m4 <- read.csv("isie2017-review//bcsalefda.m-experiment_round-ranking-01knn-atfalse.txt.confusion.csv")
